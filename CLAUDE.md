...
### Business baseline (as of 2026-08-04 — weekly-retro updates this block)

726 paying subs · 9 new paid/wk · 27 pass sales/wk · 9.1%/mo churn (DB approximation: 66 cancels/30d ÷ 726 active; 75% lifecycle per last-14d cancel reasons, not price) · 14,850 registered (down 547 from 2026-07-26 — inactive-user deletion outpacing 191 gross signups/wk, not churn). MRR/ARPU no longer tracked here (decision 2026-07-19) — dollar figures read off the Stripe dashboard when needed. Funnel events at `/api/ops/metrics`.
