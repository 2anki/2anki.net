...
// Per-user AI credit allowance — enforced in lib/claude/aiSpendGuard
// (assertAiBudget, called before every metered Claude call). Each plan carries
// a credit allowance (1 credit = $0.01 of recorded AI cost); at zero the
// upload path falls back to the standard parser and the interactive surfaces
// pause. The $25 alert threshold only emails ops. The allowance table lives in
// lib/claude/aiCredits/allowance.
export { AI_SPEND_ALERT_THRESHOLD_USD } from './claude/aiSpendGuard';
